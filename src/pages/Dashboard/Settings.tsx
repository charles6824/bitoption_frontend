		...
		<div>
			...
			<Tabs value={activeTab}>
				...
				>
							...
							<div className="mt-8 border border-[#ccc] rounded-md p-5 ">
								<div className="py-3 text-black flex flex-col">
									...
									<input
										...
										readOnly
										type="text"
										className=" w-full md:w-[50%] bg-gray-50 py-3 text-black text-[13px] px-3 border border-[#ccc] rounded-md"
							...
							<div>
								<div className="w-full border p-5 mt-20">
									<form
										...
										className="space-y-4 text-white w-full md:w-[60%] "
									>
										<div>
											<input
												value={oldPassword}
					...
					{activeTab === "sendfeedback" && (
						<>
							<div className="border px-3 py-6 md:p-6 mt-5">
								<div className="">
									<select
										className="border border-[#ccc] p-3 w-full md:w-[60%] rounded-md outline-none"
										value={feedbackType}
								...
								{feedbackType && (
									<form onSubmit={handleFeedback} className="mt-5">
										<textarea
											...
											className="border w-full md:w-[60%] py-3 px-3"
